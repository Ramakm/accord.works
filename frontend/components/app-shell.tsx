...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  if (isDashboard) {
    return (
      <div className="min-h-screen bg-site-gradient text-slate-900 dark:bg-slate-950 dark:text-slate-100">
            ...
            <div className="grid grid-cols-2 gap-6 sm:justify-items-end">
              ...
              <div>
                ...
                <ul className="mt-3 space-y-2 text-sm text-slate-600 dark:text-slate-300">
                  ...
                  <li><a className="hover:text-slate-900 dark:hover:text-white" href="/signin">Try Free</a></li>
                </ul>
              </div>
            </div>
          </div>
